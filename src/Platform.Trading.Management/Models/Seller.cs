...
public class Seller
{
    ...
    // Seller-specific information (e.g., types of minerals sold, production capacity)
    public List<MetalType> MineralsSold { get; set; } = new List<MetalType>();
    public decimal ProductionCapacityPerMonth { get; set; } // in metric tons
}
